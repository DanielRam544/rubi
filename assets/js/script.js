...
function muestraSucursal() {
	...
	nuevoDiv.innerHTML =
        '<div class="card-header">Joyería Rubí</div>' +
        '   <div class="card-body">' +
    ...
    // nuevoFrame.width = 700;
    // nuevoFrame.height = 550;
    // nuevoFrame.style = "border:0; padding-bottom: 10px;";
